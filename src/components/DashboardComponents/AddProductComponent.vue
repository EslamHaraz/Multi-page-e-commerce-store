<template>
  <div class="parent">
    <h1 class="text-initial head text-color">{{ $t("message.addProduct") }}</h1>
    <form @submit.prevent class="form">
      ...
      <div class="form-group mb-3">
        ...
        >
        <textarea
          class="form-control w-70 resize-none text-start"
      ...
      <div class="form-group mb-3">
        ...
        >
        <textarea
          class="form-control w-70 resize-none text-end"
          id="Description"
          rows="4"
